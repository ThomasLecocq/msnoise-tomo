...
from msnoise_tomo.default import default
...
from msnoise_tomo import plugin_definition as M
...
out.write('Help on the msnoise-tomo commands\n')
out.write('=================================\n\n')
...
project = u'MSNoise-TOMO'
copyright = u'%i, Lecocq & Mordret' % datetime.datetime.now().year
